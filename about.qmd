...
![](media/IMG_7493.jpg){.lightbox style="display: block; margin: auto;" group="YCT" description="Me and other YCT members conducting tree maintenance"}

![](media/IMG_7494.jpg){.lightbox style="display: block; margin: auto;" group="YCT" description="Me and other YCT members planting a tree and setting up a tree gator"}

![](media/IMG_7495.jpg){.lightbox style="display: block; margin: auto;" group="YCT" description="Me and other YCT members carrying irrigation piping"}
:::
...
![](media/SproutUp_1.jpg){.lightbox style="display: block; margin: auto;" group="sprout" description=" Sprout Up Fall 2024"}

![](media/SproutUp_2.jpg){.lightbox style="display: block; margin: auto;" group="sprout" description="Sprout Up Fall 2024"}

![](media/SproutUp_3.jpg) {.lightbox style="display: block; margin: auto;" group="sprout" description="Sprout Up Winter 2025"}
